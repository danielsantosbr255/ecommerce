    ...
    <aside className="w-64 bg-white py-8 px-4 shadow-md hidden flex-col justify-between z-50 lg:flex">
      <div>
        ...
        <nav className="space-y-3">
          ...
          <Link href="/admin" className="flex items-center space-x-2 text-gray-700 hover:text-amber-500">
            <Settings size={20} />
      ...
      <div className="mt-6 flex justify-between">
        <Link href="/" className="flex items-center space-x-2 text-gray-600 hover:text-amber-500">
          <Store size={20} />
  ...
  return (
    <div className="bg-white w-full flex fixed bottom-0 h-16 shadow-md items-center z-40 lg:hidden border-t border-gray-200">
      <nav className="grid grid-cols-5 items-center text-sm justify-center h-full w-full text-gray-700">
        <Link href="/admin" className="flex flex-col items-center hover:text-amber-500">
          <LayoutDashboard size={20} />
          <span>Dashboard</span>
        </Link>
        <Link href="/admin/products" className="flex flex-col items-center hover:text-amber-500">
          <Package size={20} />
          <span>Produtos</span>
        </Link>
        <Link href="/admin/orders" className="flex flex-col items-center hover:text-amber-500">
          <ClipboardList size={20} />
          <span>Pedidos</span>
        </Link>
        <Link href="/admin/users" className="flex flex-col items-center hover:text-amber-500">
          <Users size={20} />
          <span>Usuários</span>
        </Link>
        <Link href="/admin" className="flex flex-col items-center hover:text-amber-500">
